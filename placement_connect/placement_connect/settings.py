...
INSTALLED_APPS = [
    ...
    'placement_connect.portal',
    'placement_connect.users',
]
...
ROOT_URLCONF = 'placement_connect.placement_connect.urls'
...
WSGI_APPLICATION = 'placement_connect.placement_connect.wsgi.application'
